...
district_mapping <- c("1" = "Nellore", "2" = "Anantapur",
                      "3" = "Kurnool", "4" = "Krishna", "5" = "West Godavari", "6" = "East Godavari",
                      "7" = "Tirupati", "8" = "Eluru", "9" = "Vizag", "10" = "Guntur", "11" = "Prakasam", "12" = "Chittoor", `13` = "Kadapa", `14` = "Srikakulam", `15` = "Vizianagaram", `16` = "NTR District", `17` = "Alluri Sitaramaraju dt", `18` = "Warangal", `19` = "Bapatla", `20` = "Vijayawada", `21` = "Rajamundry", `22` = "Machilipatanam", `23` = "Puttaparthi"
)
